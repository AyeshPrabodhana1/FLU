...
class AddReminderController {
  static final AddReminderController _addReminderController =
      AddReminderController._internal();

  factory AddReminderController() {
  ...
  Future<String> insertReminder(
    ...
    final result = await databaseController.insertNewReminder(reminder);

    if (result) {
      return 'success';
    } else {
      return 'Cannot insert data to the Database!';
    }
  }

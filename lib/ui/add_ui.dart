...
import 'package:med_reminder/controllers/add_reminder_controller.dart';
...
class _AddUIState extends State<AddUI> {
  ...
  void _submitData() async {
    AddReminderController addReminderController = new AddReminderController();
    final result = await addReminderController.insertReminder(
    ...
    if (result == 'success') {
      ArtDialogResponse dialog = await ArtSweetAlert.show(
          ...
          artDialogArgs: ArtDialogArgs(
            ...
            showCancelBtn: false,
            title: 'Success!',
            text: 'New reminder saved successfully!',
          ));
